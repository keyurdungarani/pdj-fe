              ...
              <div className="container mx-auto px-6 sm:px-8 lg:px-12">
                <div className="max-w-xl">
                  ...
                  <div className="mb-3 sm:mb-4">
                    <span className="inline-flex items-center px-2.5 py-1 bg-white/20 backdrop-blur-md rounded-full text-white text-xs font-medium border border-white/30">
                      <span className="w-1 h-1 bg-white rounded-full mr-1.5 animate-pulse"></span>
                      {slide.category}
                    </span>
                  </div>
                  
                  {/* Main heading - positioned in bottom left */}
                  <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-white mb-3 sm:mb-4 leading-tight tracking-wide">
                    {slide.title}
                  </h3>
                  
                  {/* Subtitle */}
                  <p className="text-sm sm:text-base lg:text-lg text-white/90 mb-5 sm:mb-6 leading-relaxed font-light">
                    {slide.subtitle}
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3">
                    <Link
                      to={slide.linkUrl}
                      className="group inline-flex items-center justify-center px-5 sm:px-6 py-2.5 sm:py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                    >
                    ...
                    <Link
                      to="/book-appointment"
                      className="group inline-flex items-center justify-center px-5 sm:px-6 py-2.5 sm:py-3 border-2 border-white/80 text-white font-semibold rounded-lg hover:bg-white hover:text-gray-900 transition-all duration-300 backdrop-blur-sm"
                    >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-12 md:mb-16">
            <div className="text-center flex-1">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-900 mb-3 md:mb-4">Shop by Category</h2>
                      ...
                      {displayCategories
                        ...
                        .map((category, index) => (
                          ...
                          >
                            ...
                            <h3 className="text-lg md:text-xl font-medium text-gray-900 group-hover:text-primary transition-colors duration-300">
                              {category.title}
                            </h3>
                          </Link>
                        ))}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-block mb-3">
              ...
              <p className="text-xs text-gray-500 font-medium tracking-wide uppercase">Trusted by 900+ happy customers</p>
            </div>
          ...
          <div className="max-w-5xl mx-auto">
                ...
                >
                  <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 relative">
                    ...
                    <div className="text-center pt-4">
                      ...
                      {/* Review text */}
                      <blockquote className="text-xl lg:text-2xl text-gray-800 font-light leading-relaxed mb-6 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-900 mb-1 text-sm">Verified Reviews</h3>
                <p className="text-gray-600 text-xs">All reviews are from genuine customers</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Award className="w-6 h-6 text-blue-600" />
                </div>
                <h3 className="font-semibold text-gray-900 mb-1 text-sm">Award Winning</h3>
                <p className="text-gray-600 text-xs">Recognized for excellence in jewelry</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Heart className="w-6 h-6 text-purple-600" />
                </div>
                <h3 className="font-semibold text-gray-900 mb-1 text-sm">Customer Love</h3>
                <p className="text-gray-600 text-xs">98% customer satisfaction rate</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center">
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2 hover:text-primary transition-colors">Call Our Experts</h3>
            ...
            <div className="text-center">
              ...
              >
                ...
                <h3 className="text-lg font-semibold mb-2 hover:text-primary transition-colors">Virtual Consultation</h3>
